...
const (
	SystemService_GetInfo_FullMethodName = "/brickly.runtime.v1.SystemService/GetInfo"
)
...
type SystemServiceClient interface {
	GetInfo(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*SystemInfo, error)
}
...
func (c *systemServiceClient) GetInfo(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*SystemInfo, error) {
...
type SystemServiceServer interface {
	GetInfo(context.Context, *emptypb.Empty) (*SystemInfo, error)
...
func (UnimplementedSystemServiceServer) GetInfo(context.Context, *emptypb.Empty) (*SystemInfo, error) {
...
var SystemService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "brickly.runtime.v1.SystemService",
